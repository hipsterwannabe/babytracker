...
<div clas="container">
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="thumbnail">
                <img src="/images/danny.jpg" alt="Danny Jimenez">
                    <div class="caption">
                    <h3>Danny Jimenez</h3>
        ...
        <div class="col-md-4">
            <div class="thumbnail">
                <img src="/images/greg_02.jpg" data-alt-src="/images/babygreg.jpg" class="img-responsive img-circle headshot3" alt="Greg Vallego">
                <div class="caption">
                    <h3>Greg Vallejo</h3>
